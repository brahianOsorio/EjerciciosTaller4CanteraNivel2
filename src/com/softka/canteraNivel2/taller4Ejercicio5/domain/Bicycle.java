...
/**
 * Esta clase es la que representa a una bicicleta
 * 
...
public class Bicycle extends Vehicle implements VehicleInterface{
	...
	/**
	 * Este es el constructor del objeto Bicycle 
	 * 
	 ...
	 * 
	 */
	public Bicycle(int numberOfPassengers, boolean thereArePassagers, int numberOfWheels, Calendar dateOfRegistraton,
			String typeOfRoad, String color) {
		super();
		this.typeOfVehicle = "Bicycle";
