...
/**
 * Esta clase es la que representa a un barco
 * 
...
public class Boat extends Vehicle implements VehicleInterface {
	...
	/**
	 * Este es el constructor del objeto Boat 
	 * 
	 ...
	 * 
	 */
	public Boat(int numberOfPassengers, boolean thereArePassagers, int numberOfWheels,
