...
/**
 * Esta clase es la que representa a un camion
 * 
...
public class Truck extends Vehicle implements VehicleInterface{
	...
	/**
	 * Este es el constructor del objeto Truck 
	 * 
	 ...
	 * 
	 */
	public Truck(int numberOfPassengers, boolean thereArePassagers, int numberOfWheels,
