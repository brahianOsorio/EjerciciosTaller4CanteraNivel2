...
/**
 * Esta clase es la que representa a un carro
 * 
...
public class Car extends Vehicle implements VehicleInterface{
	/**
	 * Este es el constructor del objeto Car 
	 * 
	 ...
	 * 
	 */
	public Car(int numberOfPassengers, boolean thereArePassagers, int numberOfWheels,
